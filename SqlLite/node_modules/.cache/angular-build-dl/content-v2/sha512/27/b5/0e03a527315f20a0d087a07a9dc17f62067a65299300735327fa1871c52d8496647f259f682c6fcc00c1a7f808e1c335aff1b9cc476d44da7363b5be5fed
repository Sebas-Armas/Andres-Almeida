(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function ZJFI(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(DatabaseService, [{
          ...
          value: function seedDatabase() {
            ...
            this.http.get('assets/seed.sql', {
              ...
              _this2.sqlitePorter.importSqlToDb(_this2.database, sql).then(function (_) {
                _this2.loadDevelopers();
          ...
          key: "loadDevelopers",
          value: function loadDevelopers() {
            var _this3 = this;

            return this.database.executeSql('SELECT * FROM marca', []).then(function (data) {
              var developers = [];
              ...
              _this3.developers.next(developers);
            });
          }
        }, {
          key: "addDeveloper",
          value: function addDeveloper(name) {
            var _this4 = this;

            var data = [name];
            return this.database.executeSql('INSERT INTO marca (name) VALUES (?)', data).then(function (data) {
              _this4.loadDevelopers();
            });
          }
        }, {
          key: "getDeveloper",
          value: function getDeveloper(id) {
            return this.database.executeSql('SELECT * FROM marca WHERE id = ?', [id]).then(function (data) {
              return {
          ...
          key: "deleteDeveloper",
          value: function deleteDeveloper(id) {
            var _this5 = this;

            return this.database.executeSql('DELETE FROM marca WHERE id = ?', [id]).then(function (_) {
              _this5.loadDevelopers();
          ...
          key: "updateDeveloper",
          value: function updateDeveloper(dev) {
            var _this6 = this;

            var data = [dev.name];
            return this.database.executeSql("UPDATE marca SET name = ? WHERE id = ".concat(dev.id), data).then(function (data) {
          ...
          value: function loadProducts() {
            ...
            var query = 'SELECT modelo.name, modelo.costo, modelo.color, modelo.anio, marca.name AS marca FROM modelo JOIN marca ON marca.id = modelo.marcaId';
            return this.database.executeSql(query, []).then(function (data) {
              ...
              _this7.products.next(products);
            });
          }
        }, {
          key: "addProduct",
          value: function addProduct(name, color, costo, anio, marcaId) {
            var _this8 = this;

            var data = [name, color, costo, anio, marcaId];
            return this.database.executeSql('INSERT INTO modelo (name, color, costo, anio, marcaId) VALUES (?, ?, ?, ?, ?)', data).then(function (data) {
              _this8.loadProducts();
            });
          }
        }]);
      ...
      DatabaseService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], DatabaseService);
      /***/
    },
