...
module.exports = __webpack_require__(/*! /Users/Andres/Desktop/AndresAlmeidaSqlLite/SqlLite/src/main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'developers',
        loadChildren: () => Promise.all(/*! import() | pages-developers-developers-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-developers-developers-module")]).then(__webpack_require__.bind(null, /*! ./pages/developers/developers.module */ "ZsP5")).then(m => m.DevelopersPageModule)
    },
    {
        path: 'developer/:id',
        loadChildren: () => Promise.all(/*! import() | pages-developer-developer-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-developer-developer-module")]).then(__webpack_require__.bind(null, /*! ./pages/developer/developer.module */ "mJAW")).then(m => m.DeveloperPageModule)
    },
];
